...
parser = argparse.ArgumentParser(description='SR-GAN')
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/ysx/xyj/datasets/sr/',
...
# options for test
parser.add_argument('--testpath', type=str, default='../LR',
                    help='dataset directory for testing')
parser.add_argument('--bi_blur_path', type=str, default='BI_0',
                    help='dataset directory for testing')
