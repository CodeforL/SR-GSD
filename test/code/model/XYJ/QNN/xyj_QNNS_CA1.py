...
class QNNS(nn.Module): #QNNS
    def __init__(
        ...
        self.conv1_1 = nn.Sequential(
                nn.Conv2d(n_feat, 10 , 1, padding=0, bias=True),
                nn.ReLU(inplace=True),
        ...
        self.conv2_0 = nn.Sequential(
                nn.Conv2d(n_feat, n_feat , 3, padding=1, bias=True),
                nn.ReLU(inplace=True),
                nn.Conv2d(n_feat, 10 , 5, padding=2, bias=True),
                nn.ReLU(inplace=True),
        )
        self.conv3_0 = nn.Sequential(
                nn.Conv2d(n_feat, 10 , 3, padding=1, bias=True),
                nn.ReLU(inplace=True),
        )
        ...
        self.conv4_1 = nn.Sequential(
                nn.Conv2d(10, 10 , 3, padding=1, bias=True),
                nn.ReLU(inplace=True),
        )
        ...
        self.conv6_0 = nn.Sequential(
                nn.Conv2d(n_feat, 14 , 1, padding=0, bias=True),
                nn.ReLU(inplace=True),
        )
        '''
        self.conv = nn.Sequential(
    ...
    def forward(self,x):
        ...
        return torch.cat([index1,index2,index3,index4,index5,index6],1)
