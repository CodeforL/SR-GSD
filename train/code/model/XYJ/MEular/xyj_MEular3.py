...
class MEuler(nn.Module):
    def __init__(
        ...
        res1_body = []
        for i in range(2):
            res1_body.append(conv(n_feat, n_feat, kernel_size, bias=bias))
        ...
        res2_body = []
        for i in range(2):
            res2_body.append(conv(n_feat, n_feat, kernel_size, bias=bias))
    ...
    def forward(self,x):
        ...
        out = x + res_1
        res_2 = self.res2(out)
        out = out + self.ca(self.conv(res_1+res_2))
        return out
